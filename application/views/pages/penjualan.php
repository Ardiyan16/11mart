...
<script>
    ...
    function BarisBaru() {
        ...
        //6
        baris += "<td><input type='text' name='harga_grosir[]' id='harga_grosir' class='form-control harga_grosir" + nomor + "'></td>";
    ...
    function cariBarang(keyword, Indexnya, foundItem) {
        ...
        foundItem.forEach((b, i) => {
            ...
            htmlFoundItem += `
                ...
                +
                `
					<span id='kode'>` + b.kode_barang + `</span> <br />
					<span id='id_brg'>` + b.id + `</span> <br />
					<span id='nama_brg'>` + b.nama_barang + `</span><br />
					<span id='harga_brg' style='display:none;'>` + b.harga_jual + `</span>
				</li>
			`;
        })
        htmlFoundItem += "</ul>";
        ...
        if (e.which == 40) {
            ...
            for (let i = 0; i < dataBarang.length; i++) {
                ...
                if (
                    ...
                    ((dataBarang[i].kode_barang ? dataBarang[i].kode_barang : '').toLowerCase()).includes(keyword.toLowerCase()) ||
                    ((dataBarang[i].id ? dataBarang[i].id : '').toLowerCase()).includes(keyword.toLowerCase()) ||
                    ((dataBarang[i].nama_barang ? dataBarang[i].nama_barang : '').toLowerCase()).includes(keyword.toLowerCase())
                ) {
                ...
                if ($(this).parent().find('#hasil_pencarian > #daftar-autocomplete').is(':visible') && tempKeyword) {
                    $(this).parent().find("#hasil_pencarian > #daftar-autocomplete li").each(function(i, e) {
                        if ($(this).hasClass('--focus')) {
                            ...
                            var HargaBarang = $(this).find('span#harga_brg').html();


                            $('#tabeltransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(2)').find('div#hasil_pencarian').hide();
                            $('#tabeltransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(3) input#nama_barang').val(NamaBarang);
                            // $('#tabeltransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(4) input#qty').val(0);
                            $('#tabeltransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(5) input#harga_jual').val(HargaBarang);
                            ...
                            // $('#tabeltransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(6) input#harga_pergram').val(0);
    ...
    $(document).on('keyup', '#qty', function() {
        ...
        var Harga = $('#tabeltransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(5) input#harga_jual').val();
