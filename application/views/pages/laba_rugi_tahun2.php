            ...
            <div class="table-responsive">
                <table class="table table-striped table-custom" id="tbl_labarugi">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td id='totalPenjualan'><?= $total_penjualan ?></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>- Biaya Listrik</td>
                        <td></td>
                        <td id='listrik'><?= $listrik ?></td>
                    </tr>
                    <tr>
                        <td>- Biaya Kebersihan</td>
                        <td></td>
                        <td id='kebersihan'><?= $kebersihan ?></td>
                    </tr>
                    <tr>
                        <td>- Biaya Pajak</td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td id='lainlain'><?= $lainlain ?></td>
                    </tr>
                    <tr>
                        <td>- Biaya Kulaan</td>
                        <td></td>
                        <td id='kulaan'><?= $kulaan ?></td>
                    </tr>
                    <tr>
                        <td>- Total Beban</td>
                        <td></td>
                        <td id='totalbeban'><?= $total_beban ?></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td id='lababersih'><?= $laba_bersih ?></td>
                    </tr>
                </table>
            </div>
        </div>
